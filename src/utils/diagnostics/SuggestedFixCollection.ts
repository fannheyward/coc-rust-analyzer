 ...
 */
export default class SuggestedFixCollection implements CodeActionProvider {
  public static PROVIDED_CODE_ACTION_KINDS = [CodeActionKind.QuickFix];
   ...
   * diagnostic.
   */
  public addSuggestedFixForDiagnostic(suggestedFix: SuggestedFix, diagnostic: Diagnostic): void {
